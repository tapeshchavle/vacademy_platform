...
public class AssessmentJwtAuthFilter extends OncePerRequestFilter {
    ...
    // ── Session-limit enforcement caches ──
    private record CacheEntry(boolean value, long expiresAt) {
        boolean isExpired() { return System.currentTimeMillis() > expiresAt; }
    }
    private static final long INSTITUTE_LIMIT_TTL_MS = 60 * 60 * 1000L;
    private static final long SESSION_ACTIVE_TTL_MS  = 10 * 60 * 1000L;
