...
# This script builds the Seven CS branded app

set -e

echo "Building Windows Electron app for Seven CS..."
...
npx electron-builder build --win --prepackaged dist/win-unpacked -c ./electron-builder.seven_cs.json

echo "Build complete!"
echo "Installers location: dist/Seven CS Learner Setup 1.0.7.exe (x64)"
echo "                     dist/Seven CS Learner 1.0.7.exe (ARM64)"
ls -lh dist/*.exe
