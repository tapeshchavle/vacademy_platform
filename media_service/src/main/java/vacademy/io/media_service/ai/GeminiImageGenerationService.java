...
public class GeminiImageGenerationService {
    ...
    private static final String GEMINI_IMAGE_URL_TEMPLATE = "https://generativelanguage.googleapis.com/v1beta/models/gemini-3.1-flash-image-preview:generateContent?key=%s";
