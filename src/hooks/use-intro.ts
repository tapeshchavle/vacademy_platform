...
const useIntroJsTour = ({
    ...
    useEffect(() => {
        ...
        const timeoutId = delay ? setTimeout(startIntroTour, delay) : startIntroTour();
    ...
    }, [getValue, setValue, steps, key, onTourExit, hasDisplayedIntro, delay]);
