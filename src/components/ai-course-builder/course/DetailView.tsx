                    ...
                    onClick={() => {
                      ...
                      content.questions.forEach(q => {
                        ...
                        if (q.type === 'multiple-choice') {
                          ...
                          if (Array.isArray(q.correct) && Array.isArray(ans)) {
                            const aSet = new Set(ans);
                            const cSet = new Set(q.correct);
                            if (aSet.size === cSet.size && [...aSet].every(v => cSet.has(v))) {
                              correct += 1;
                            }
                          }
                        }
  ...
  return (
    <div className="detail-view">
      ...
      <div className="detail-content">
        {selectedItem?.type === 'slide' ? renderSlideContent(selectedItem.data as Slide) : renderNonSlideContent()}
      </div>
    </div>
  );
};
