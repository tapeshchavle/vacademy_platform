...
export const NonCollapsibleItem = ({ icon, title, to, locked }: SidebarItemProps) => {
            ...
            <TooltipTrigger asChild>
                ...
                >
                    {locked ? (
                        <div
                            className={cn(
                                'flex w-full cursor-pointer items-center gap-1 rounded-lg px-4 py-2 hover:bg-white',
