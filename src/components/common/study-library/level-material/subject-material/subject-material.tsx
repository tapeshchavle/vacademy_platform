...
export const SubjectMaterial = () => {
  ...
  const isAllExpanded = studyLibraryData?.every(subject => openSubjects.has(subject.id)) && 
      ...
      <div className="space-y-4">
        ...
        <div className="flex items-center justify-between border-b border-neutral-200 pb-3">
          <div className="flex items-center gap-2">
            ...
            <span className="text-sm font-medium text-neutral-700">Course Structure</span>
          </div>
          <div className="flex items-center gap-2">
            <Button
              variant="outline"
              ...
              >
                <CollapsibleTrigger className="group flex w-full items-center rounded-lg px-3 py-2 text-left text-sm font-semibold text-neutral-700 transition-all duration-200 hover:bg-gradient-to-r hover:from-primary-50/60 hover:to-blue-50/40 hover:border-primary-200/60 border border-transparent focus:outline-none focus-visible:ring-2 focus-visible:ring-primary-500 focus-visible:ring-offset-1">
                  <div className="flex min-w-0 flex-1 items-center gap-2.5">
                    ...
                    <span className="truncate font-medium group-hover:text-primary-700 transition-colors" title={subject.subject_name}>
      ...
      <div className="w-full flex flex-col items-center justify-center">
        {!studyLibraryData?.length ? (
          <div className="flex w-full h-[70vh] flex-col items-center justify-center gap-8 rounded-lg">
            ...
            <div className="text-neutral-600">No study materials have been added yet.</div>
          </div>
        ) : (
          <div
    ...
    [TabType.TEACHERS]: (
      <div className="rounded-lg bg-gradient-to-br from-white to-neutral-50/50 border border-neutral-200 p-6 text-sm text-neutral-600">
        <div className="flex items-center gap-3 mb-3">
          ...
          <span className="font-medium text-neutral-700">Teachers</span>
        </div>
        <p className="text-neutral-500">Teachers content coming soon.</p>
      </div>
    ),
    [TabType.ASSESSMENT]: (
      <div className="rounded-lg bg-gradient-to-br from-white to-neutral-50/50 border border-neutral-200 p-6 text-sm text-neutral-600">
