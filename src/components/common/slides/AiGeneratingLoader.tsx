...
export const aiSteps = [
    ...
    { text: 'Structuring the presentation outline...', icon: FileText },
    { text: 'Drafting content for each slide...', icon: Bot },
    { text: 'Creating assessment questions...', icon: Sparkles },
    { text: 'Finalizing your presentation...', icon: CheckCircle },
];

export const pptSteps = [
    { text: 'Uploading your presentation...', icon: FileUp },
...
export const AiGeneratingLoader = ({
    ...
    return (
        <div className="flex flex-col items-center justify-center p-8 space-y-6 bg-white rounded-lg min-h-[400px]">
            <div className="relative">
                <Bot className="h-16 w-16 text-orange-500 animate-pulse" />
                            ...
                            <div className="flex items-center justify-center w-8 h-8">
                                {isCompleted ? (
                                    ...
                                    <div className="relative flex items-center justify-center w-6 h-6">
                                        ...
                                        <Icon className={`w-5 h-5 transition-colors duration-300 ${isActive ? 'text-orange-600' : 'text-neutral-400'}`} />
                                    </div>
                                )}
                            </div>
                            <span className={`transition-colors duration-300 ${isActive ? 'text-orange-600 font-semibold' : isCompleted ? 'text-neutral-700 line-through' : 'text-neutral-500'}`}>
                                {step.text}
                            </span>
                        </div>
                    );
