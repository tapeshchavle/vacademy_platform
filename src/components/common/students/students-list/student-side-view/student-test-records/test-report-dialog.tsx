...
import { TestReportDataFormat } from "./test-report-data-format";
...
export const TestReportDialog = ({ isOpen, onClose, testReport }: TestReportDialogProps) => {
    ...
    const report = TestReportDataFormat(testReport);

    const marksData = report.marksData;
    const responseData = report.responseData;
