                    ...
                    <FormControl>
                      <div className="flex flex-col gap-1">
                        ...
                        <MyDropdown
                          ...
                          error={
                            form.formState.errors.session?.id?.message ||
                ...
                render={({ field: { value } }) => (
                  <FormItem className="w-full">
                    <FormControl>
                      <div className="flex flex-col gap-1">
                        <div>
                          Level <span className="text-subtitle text-danger-600">*</span>
                        </div>
                        <MyDropdown
                          currentValue={value.name}
                      ...
                      <FormItem>
                        <FormControl>
                          <MyInput
                            ...
                            input={value}
                            onChangeFunction={onChange}
                            error={form.formState.errors.enrollmentNumber?.message}
                            required={true}
                            size="large"
                            className="w-full"
                            {...field}
                ...
                render={({ field: { onChange, value } }) => (
                  <FormItem className="w-full">
                    <FormControl>
                      <div className="flex flex-col gap-1">
                        <div>
                          Gender <span className="text-subtitle text-danger-600">*</span>
                        </div>
                        <MyDropdown
                          currentValue={value}
