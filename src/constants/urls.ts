...
export const LIVE_SESSION_GET_SESSION_BY_SCHEDULE_ID_FOR_GUEST = `http://localhost:8072/admin-core-service/live-session/guest/get-session-by-schedule-id`;
...
export const LIVE_SESSION_GET_EARLIEST_SCHEDULE_ID = `http://localhost:8072/admin-core-service/live-session/get-earliest-schedule-id`;
