...
export function ThemeProvider({ children }: { children: React.ReactNode }) {
  ...
  useEffect(() => {
    ...
    document.documentElement.style.setProperty("--primary-50", `${h} ${Math.min(s + 40, 100)}% ${Math.min(l + 45, 96)}%`)
    document.documentElement.style.setProperty("--primary-100", `${h} ${Math.min(s + 30, 90)}% ${Math.min(l + 38, 92)}%`)
    document.documentElement.style.setProperty("--primary-200", `${h} ${Math.min(s + 20, 88)}% ${Math.min(l + 29, 83)}%`)
    document.documentElement.style.setProperty("--primary-300", `${h} ${Math.min(s + 10, 87)}% ${Math.min(l + 18, 72)}%`)
    document.documentElement.style.setProperty("--primary-400", `${h} ${Math.min(s + 5, 86)}% ${Math.min(l + 7, 61)}%`)
    ...
    document.documentElement.style.setProperty("--secondary", `${hSecondary} ${s}% ${l}%`)
    document.documentElement.style.setProperty(
