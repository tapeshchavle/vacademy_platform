...
import { planLectureDummyData } from "../../vsmart-lecture/-components/dummyData";
import { MyButton } from "@/components/design-system/button";

const EvaluateReportComponent = () => {
    return (
            ...
            <div className="flex flex-col gap-4">
                    ...
                    <div className="flex flex-col gap-1">
                        <div className="flex flex-nowrap items-center">
                            ...
                            <span className="text-sm font-thin">
                                Speaker enunciated words clearly, maintained a moderate pace, and
                                used minimal filler words.
                            </span>
                        </div>
                        <div className="flex flex-nowrap items-center">
                            <span className="text-sm font-semibold">
                ...
                <div className="flex flex-col gap-3">
                    ...
                    <div className="flex flex-col gap-1">
                        ...
                        <div className="flex flex-nowrap items-center">
                            <span className="text-sm font-semibold"> • Responsiveness: &nbsp;</span>
                            <span className="text-sm font-thin">
                                Speaker enunciated words clearly, maintained a moderate pace, and
                                used minimal filler words.
                            </span>
                ...
                <div className="flex flex-col gap-3">
                    <div className="flex items-center gap-4">
                        <h1 className="font-semibold">6. Classroom Management (Audible Cues)</h1>
                        <span className="text-primary-300">(Score: 17/20)</span>
                    </div>
                    <div className="flex flex-col gap-1">
                        <div className="flex flex-nowrap items-center">
                ...
                <div className="flex flex-col gap-3">
                    <div className="flex items-center gap-4">
                        <h1 className="font-semibold">7. Teaching Aids (Inferred from Audio)</h1>
                        <span className="text-primary-300">(Score: 17/20)</span>
                    </div>
                    <div className="flex flex-col gap-1">
                        <div className="flex flex-nowrap items-center">
                ...
                <div className="flex flex-col gap-3">
                    ...
                    <div className="flex flex-col gap-1">
                        <div className="flex flex-nowrap items-center">
                            <span className="text-sm font-semibold"> • Preparation: &nbsp;</span>
                            <span className="text-sm font-thin">
                                Speaker enunciated words clearly, maintained a moderate pace, and
                                used minimal filler words.
                            </span>
