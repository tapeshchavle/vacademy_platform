  ...
  return (
    <div className="relative min-h-[200px] bg-gradient-to-br from-gray-50/80 via-white to-primary-50/20 overflow-hidden w-full max-w-full">
      ...
      <div className="absolute inset-0 overflow-hidden pointer-events-none">
        ...
        <div
          className="absolute bottom-1/3 right-1/3 w-20 md:w-40 h-20 md:h-40 bg-gradient-to-br from-primary-50/30 to-transparent rounded-full blur-3xl animate-gentle-pulse"
          ...
          <div className="animate-fade-in-up max-w-2xl text-center lg:text-left">
            ...
            <div className="mb-3 sm:mb-4">
              <p className="text-sm sm:text-base text-gray-600 font-medium leading-relaxed">
                Effortlessly organize, upload, and track educational resources
                in one place.
              </p>
            </div>
          </div>
