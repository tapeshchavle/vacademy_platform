      ...
      {activeTab === "settings" ? (
        <>
          <div style={{ marginBottom: "20px" }}>
            ...
            <div style={{ maxWidth: "400px" }}>
              ...
              <small style={{ color: "#666", fontSize: "12px", marginTop: "4px", display: "block" }}>
                You can find the project ID in the Scratch project URL: scratch.mit.edu/projects/[PROJECT_ID]
              </small>
            </div>
          </div>
          ...
          <div style={{
            ...
            <h4 style={{ margin: "0 0 8px 0", fontSize: "14px", fontWeight: "600", color: "#e65100" }}>
              How to get your Scratch Project ID:
            </h4>
            <ol style={{ margin: "0", paddingLeft: "16px", fontSize: "13px", color: "#bf360c" }}>
          ...
          {scratchId && (
            <div style={{
              ...
              <strong>Project ready:</strong> Scratch project ID {scratchId} - Switch to Preview tab to view the project
            </div>
          )}
        </>
      ) : (
        ...
        <div style={{ minHeight: "400px" }}>
          {scratchId ? (
            ...
            <div style={{
              ...
              <p style={{ fontSize: "16px", marginBottom: "8px" }}>No Scratch project configured</p>
              <p style={{ fontSize: "14px", color: "#999" }}>Switch to Settings tab to enter your Scratch project ID</p>
            </div>
          )}
        </div>
      )}
