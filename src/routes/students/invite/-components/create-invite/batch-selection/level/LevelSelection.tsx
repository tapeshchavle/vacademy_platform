...
//     const optionsForInstitute = enhancedOptions.filter( (option) => !learnerChoiceSelected.includes(option.id),)
//     const [compulsoryEnhancedOptions, setCompulsoryEnhancedOptions] = useState(optionsForInstitute)
//     const optionsForLearner = enhancedOptions.filter((option) => !compulsorySelected.includes(option.id), )
//     const [learnerChoiceOptions, setLearnerChoiceOptions] = useState(optionsForLearner)

//     useEffect(()=>{
//         console.log("selected learner: ", learnerChoiceSelected)
//         console.log("compulsory options remaining: ", compulsoryEnhancedOptions)
//     }, [compulsoryEnhancedOptions])
//     useEffect(()=>{
//         console.log("selected compulsory: ", compulsorySelected)
//         console.log("learner options remaining: ", learnerChoiceOptions)
//     }, [learnerChoiceOptions])
...
//         }
//         const optionsForLearner = enhancedOptions.filter((option) => !compulsorySelected.includes(option.id),);
//         setLearnerChoiceOptions(optionsForLearner)
...
//         }
//         const optionsForInstitute = enhancedOptions.filter( (option) => !learnerChoiceSelected.includes(option.id),)
//         setCompulsoryEnhancedOptions(optionsForInstitute)
