...
const CheckEmailStatusAlertDialog = ({
    ...
    const sendOtpMutation = useMutation({
        ...
        onError: async () => {
            ...
            toast.error("This email is not registered", {
                description:
                    "Please register yourself to attempt this assessment",
                duration: 3000,
            });
    ...
    const verifyOtpMutation = useMutation({
        ...
        onSuccess: async (response) => {
            ...
            const assessmentId =
                registrationData.assessment_public_dto.assessment_id;
            ...
            if (userDetails) {
                setParticipantsDto({
                    ...
                    reattempt_count:
                        getTestDetailsOfParticipants.remaining_attempts,
                });
            }
            if (
    ...
    if (isPrivateAssessmentNotAlreadyRegistered)
        return (
            <AssessmentClosedExpiredComponent
                isExpired={false}
                assessmentName={
                    registrationData.assessment_public_dto.assessment_name
                }
                isPrivate={true}
            />
        );
