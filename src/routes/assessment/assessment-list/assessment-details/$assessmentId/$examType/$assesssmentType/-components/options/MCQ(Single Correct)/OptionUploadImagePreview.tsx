            ...
            <DialogContent className="flex flex-col gap-2 p-0">
                ...
                <div className="flex items-center gap-4 px-8 py-4">
                    <FormField
                        ...
                        name={`sections.${selectedSectionIndex}.questions.${currentQuestionIndex}.singleChoiceOptions.${option}.image.imageFile`}
                        render={({ field }) => (
                ...
                <div className="mb-2 py-3 text-center">
                    <Button type="button" variant="outline" onClick={handleFileSelect}>
                        ...
                        <FileUploadComponent
                            ...
                            control={form.control}
                            name={`sections.${selectedSectionIndex}.questions.${currentQuestionIndex}.singleChoiceOptions.${option}.image.imageName`}
                        />
                    </Button>
                </div>
            </DialogContent>
