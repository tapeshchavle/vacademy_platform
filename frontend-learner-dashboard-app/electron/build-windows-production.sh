...
# Production Windows build script for both x64 and x86 (32-bit)
# Ensures all node_modules are properly included in the installer
# This script fixes the "node modules not found" issue

set -e

echo "🚀 Building Production Windows Electron App (x64 + x86)"
echo "━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━"
echo ""
