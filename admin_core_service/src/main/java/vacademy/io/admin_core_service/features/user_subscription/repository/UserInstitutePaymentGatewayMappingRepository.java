...
public interface UserInstitutePaymentGatewayMappingRepository
        extends JpaRepository<UserInstitutePaymentGatewayMapping, String> {
    @Query("""
    ...
    Optional<UserInstitutePaymentGatewayMapping> findByUserIdAndInstitutePaymentGatewayMappingId(String userId,
            String institutePaymentGatewayMappingId);
}
