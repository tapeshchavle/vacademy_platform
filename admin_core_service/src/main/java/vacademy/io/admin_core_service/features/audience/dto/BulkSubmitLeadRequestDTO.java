...
/**
 * Bulk request for submitting simple leads (no enquiry).
 *
 * Intended shape:
 * {
 *   "audience_id": "...",
 *   "rows": [ SubmitLeadRequestDTO, ... ]
 * }
 *
...
public class BulkSubmitLeadRequestDTO {
     ...
     */
    private List<SubmitLeadRequestDTO> rows;
}
