...
public interface CatalogueInstituteMappingRepository extends JpaRepository<CatalogueInstituteMapping, String> {
    ...
    List<CatalogueInstituteMapping> findByInstituteIdAndSourceAndSourceIdAndStatusIn(String instituteId, String source, String sourceId, List<String> name);


    @Query(
            value = "SELECT * FROM catalogue_institute_mapping " +
