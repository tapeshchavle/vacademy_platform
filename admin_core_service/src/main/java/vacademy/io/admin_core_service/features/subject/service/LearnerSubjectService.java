...
public class LearnerSubjectService {
    ...
    public List<SubjectDTOWithDetails> subjectDTOWithDetails(String packageSessionId, String userId, CustomUserDetails user) {
        ...
        for (Subject subject : subjects) {
            List<LearnerModuleDTOWithDetails> moduleDTOWithDetails = learnerModuleDetailsService.getModulesDetailsWithChapters(subject.getId(), packageSessionId, userId, user);
