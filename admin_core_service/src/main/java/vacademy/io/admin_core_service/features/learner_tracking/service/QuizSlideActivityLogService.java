...
public class QuizSlideActivityLogService {
    ...
    public String addOrUpdateQuizSlideActivityLog(ActivityLogDTO activityLogDTO,
        ...
        learnerTrackingAsyncService.updateLearnerOperationsForQuiz(user.getUserId(), slideId, chapterId, moduleId,subjectId,packageSessionId,activityLogDTO);
        return activityLog.getId();
    }

    public Page<ActivityLogDTO> getQuizSlideActivityLog(String userId, String slideId, Pageable pageable, CustomUserDetails userDetails) {
