...
import vacademy.io.admin_core_service.features.course.enums.EmbeddingSourceEnums;
import vacademy.io.admin_core_service.features.course.repository.EmbeddingRepository;
...
public class EmbeddingService {
    ...
    private String serializeSlideContent(String title, Object content) {
        ...
        if (content instanceof DocumentSlide doc) {
            sb.append(doc.getData()); // Append the markdown data
        }
