...
public interface ChapterPackageSessionMappingRepository extends JpaRepository<ChapterPackageSessionMapping, String> {
        ...
        @Query("SELECT MAX(cpsm.chapterOrder) FROM ChapterPackageSessionMapping cpsm WHERE cpsm.packageSession.id = :packageSessionId")
        Integer findMaxChapterOrderByPackageSessionId(@Param("packageSessionId") String packageSessionId);
