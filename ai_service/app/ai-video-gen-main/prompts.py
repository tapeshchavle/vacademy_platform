...
HTML_GENERATION_SYSTEM_PROMPT_ADVANCED = (
    ...
    "   - `data-img-source='stock'` **(PREFERRED)**: Real-world stock photography (Pexels). Use for: nature, cities, classrooms, labs,\n"
    "     people, landscapes, food, animals, buildings, historical sites, sports, technology, medical, space, weather.\n"
    "   - `data-img-source='generate'`: AI-generated image. Use ONLY for: custom illustrations, cutout objects (`data-cutout`),\n"
    "     fantasy/fictional scenes, very specific compositions, stylized art (watercolor, flat vector).\n"
