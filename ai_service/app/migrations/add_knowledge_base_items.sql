...
-- Stores institute-specific knowledge (events, policies, processes, FAQs, etc.)
-- Content is auto-embedded into content_embeddings for semantic search by the AI chatbot.
